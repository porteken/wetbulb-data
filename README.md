...
1. **Compute**: US, Canadian, and European observations use NOAA GHCNh from 2026 onward, while earlier station history retains its ISD provenance. The pressure-aware Davies-Jones (2008) method stores daily average and maximum values; ERA5-Land fills material station gaps.
...
for North America and Europe every day at 20:27 UTC. It can also backfill a
specified year when started manually.
